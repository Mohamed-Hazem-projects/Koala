...
namespace Inventory.Data.Data_Seeds
{
    internal static class SuppliersSeed
    {
        public static List<Supplier> suppliers { get; set; } = new List<Supplier>
        {
            ...
            new Supplier{Id=2,Name="Hero Basics", Phone_Number="01555456789",Email_Address="hero@basics.com",Rating=5},
            new Supplier{Id=3,Name="Resi Trade", Phone_Number="01529999999",Email_Address="Resi@trade.com",Rating=9},
