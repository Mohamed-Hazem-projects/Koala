...
```
  ...
  animate(
    properties: JQuery.PlainObject,
    options: JQuery.EffectsOptions<TElement>
  ): this;
  /**
   * Perform a custom animation of a set of CSS properties.
   * @param properties An object of CSS properties and values that the animation will move toward.
...
```
     */
  bind(
    events: JQuery.TypeEventHandlers<TElement, undefined, TElement, TElement>
  ): this;
  /**
...
```
  ...
  children<K extends keyof SVGElementTagNameMap>(
    selector: K
  ): JQuery<SVGElementTagNameMap[K]>;
  // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
  children<E extends Element = HTMLElement>(
...
```
  ...
  // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
  closest<E extends Element = HTMLElement>(
    selector: JQuery.Selector,
    context: Element
  ): JQuery<E>;
  /**
...
```
  ...
  // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
  closest<E extends Element = HTMLElement>(
    selector_selection_element: JQuery.Selector
  ): JQuery<E>;
  closest<E extends Element = HTMLElement>(
    selector_selection_element: E | JQuery<E>
  ): JQuery<E>;
  /**
...
```
  ...
  // eslint-disable-next-line @typescript-eslint/no-invalid-void-type
  each(
    funсtion: (this: TElement, index: number, element: TElement) => void | false
  ): this;
  /**
...
```
  ...
  // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
  find<E extends Element = HTMLElement>(
    selector_element: JQuery.Selector
  ): JQuery<E>;
  find<E extends Element = HTMLElement>(
    selector_element: E | JQuery<E>
  ): JQuery<E>;
  /**
...
```
  ...
  height(
    value_function:
      | string
      | number
      | ((this: TElement, index: number, height: number) => string | number)
  ): this;
  /**
...
```
  ...
  innerWidth(
    value_function:
      | string
      | number
      | ((this: TElement, index: number, width: number) => string | number)
  ): this;
  /**
...
```
  ...
  next<K extends keyof SVGElementTagNameMap>(
    selector: K
  ): JQuery<SVGElementTagNameMap[K]>;
  // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
...
```
  ...
  nextAll<K extends keyof SVGElementTagNameMap>(
    selector: K
  ): JQuery<SVGElementTagNameMap[K]>;
  // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
  nextAll<E extends Element = HTMLElement>(
    selector?: JQuery.Selector
  ): JQuery<E>;
  /**
...
```
   ...
   */
  off(
    events: JQuery.TypeEventHandlers<TElement, any, any, any>,
    selector?: JQuery.Selector
  ): this;
  /**
     * Remove an event handler.
...
```
  ...
  parent<K extends keyof SVGElementTagNameMap>(
    selector: K
  ): JQuery<SVGElementTagNameMap[K]>;
  // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
  parent<E extends Element = HTMLElement>(
    selector?: JQuery.Selector
  ): JQuery<E>;
  /**
...
```
  ...
  parents<K extends keyof SVGElementTagNameMap>(
    selector: K | JQuery<K>
  ): JQuery<SVGElementTagNameMap[K]>;
  // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
  parents<E extends Element = HTMLElement>(
    selector?: JQuery.Selector
  ): JQuery<E>;
  /**
...
```
  ...
  prev<K extends keyof SVGElementTagNameMap>(
    selector: K
  ): JQuery<SVGElementTagNameMap[K]>;
  // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
...
```
  ...
  prevAll<K extends keyof SVGElementTagNameMap>(
    selector: K
  ): JQuery<SVGElementTagNameMap[K]>;
  // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
  prevAll<E extends Element = HTMLElement>(
    selector?: JQuery.Selector
  ): JQuery<E>;
  /**
...
```
  ...
  queue(
    queueName: string,
    newQueue: JQuery.TypeOrArray<JQuery.QueueFunction<TElement>>
  ): this;
  /**
     * Manipulate the queue of functions to be executed, once for each matched element.
     * @param newQueue The new function to add to the queue, with a function to call that will dequeue the next item.
...
```
     */
  replaceAll(
    target: JQuery.Selector | JQuery | JQuery.TypeOrArray<Element>
  ): this;
  /**
...
```
  ...
  siblings<K extends keyof SVGElementTagNameMap>(
    selector: K
  ): JQuery<SVGElementTagNameMap[K]>;
  // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
  siblings<E extends Element = HTMLElement>(
    selector?: JQuery.Selector
  ): JQuery<E>;
  /**
...
```
  ...
  val(
    value_function:
      ...
      | number
      | string[]
      | ((this: TElement, index: number, value: string) => string)
  ): this;
  /**
...
```
  ...
  width(
    value_function:
      | string
      | number
      | ((this: TElement, index: number, value: number) => string | number)
  ): this;
  /**
